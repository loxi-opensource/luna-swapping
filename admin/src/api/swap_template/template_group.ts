...
export function templateListsNotInGroup(params: any) {
    return request.get({ url: '/swap_template.template_group/notInGroupTemplateLists', params })
}

// 指定分组中的模板列表
export function templateListsInGroup(params: any) {
    return request.get({ url: '/swap_template.template_group/inGroupTemplateLists', params })
}
...
export function templateRelationEdit(params: any) {
    return request.post({ url: '/swap_template.template_group/editRelation', params })
}

// 批量添加模板到模板组
export function addTemplates(params: any) {
    return request.post({ url: '/swap_template.template_group/addTemplates', params })
}

// 从模板组移除模板
export function removeTemplate(params: any) {
    return request.post({ url: '/swap_template.template_group/removeTemplate', params })
}
