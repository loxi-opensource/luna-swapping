...
export function templateListsInCollection(params: any) {
    return request.get({ url: '/swap_template.template/inCollectionTemplateLists', params })
}

// 不在在指定合辑中的模板
export function templateListsNotInCollection(params: any) {
    return request.get({ url: '/swap_template.template/notInCollectionTemplateLists', params })
}
