<template>
    <el-card shadow="never" class="!border-none">
        <div class="flex">
            ...
            <div class="flex flex-col justify-center items-center flex-1">
                <div class="font-medium text-[24px]">{{ pager.extend.today_rewards_num }}</div>
                <div>今日发放奖励/条</div>
            </div>
            <div class="flex flex-col justify-center items-center flex-1">
            ...
            <div class="flex flex-col justify-center items-center flex-1">
                <div class="font-medium text-[24px]">{{ pager.extend.rewards_num }}</div>
                <div>共发放奖励/条</div>
            </div>
        </div>
    </el-card>
    <el-card shadow="never" class="!border-none mt-4">
        <el-form ref="formRef" class="mb-[-16px]" :model="queryParams" :inline="true">
            <el-form-item label="用户信息">
                <el-input class="w-[280px]" v-model="queryParams.new_user_info" placeholder="请输入用户ID编号/用户昵称" clearable
                    @keyup.enter="resetPage" />
            </el-form-item>
            <el-form-item label="邀请人信息">
                <el-input class="w-[280px]" v-model="queryParams.user_info" placeholder="请输入邀请人ID/昵称" clearable
                    @keyup.enter="resetPage" />
            </el-form-item>
