<template>
    ...
    <el-card class="!border-none mt-4" shadow="never">
        <el-table size="small" v-loading="pager.loading" :data="pager.lists">
            ...
            <el-table-column label="充值套餐" min-width="180" prop="recharge_package_name">
            </el-table-column>
            <el-table-column
                label="支付方式"
                prop="pay_type_desc"
            ...
            <el-table-column label="支付状态" min-width="100">
                <template #default="{ row }">
                    <div>
                        <el-tag :type="row.pay_status_text == '已支付' ? 'success' : 'warning'">
                            {{ row.pay_status_text }}
                        </el-tag>
                    </div>
            ...
            <el-table-column
                ...
                show-overflow-tooltip
            />
            <el-table-column label="IP信息" prop="login_ipinfo" width="200" show-overflow-tooltip />
