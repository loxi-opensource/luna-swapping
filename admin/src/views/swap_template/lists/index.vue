    ...
    <div>
        ...
        <el-card shadow="never" class="!border-none mt-[14px]">
            ...
            <el-table size="large" class="mt-4" v-loading="pager.loading" :data="pager.lists">
                ...
                <el-table-column label="关联模板组" min-width="100" show-overflow-tooltip>
                    <template #default="{ row }">
                        {{
                ...
                <el-table-column label="子模版数量" prop="child_template_cnt" min-width="100">
                    <template #default="{ row }">
...
import { EditPen, FolderOpened, InfoFilled, MagicStick } from '@element-plus/icons-vue'
