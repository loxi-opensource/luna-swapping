        ...
        >
            <el-form ref="formRef" :model="formData" label-width="84px" :rules="formRules">
                ...
                <el-form-item v-else label="封面图" prop="image_url" required>
                    <material-picker v-model="formData.image_url" :limit="1"></material-picker>
                </el-form-item>
                ...
                <el-form-item label="模板类型" prop="status">
                    <el-radio-group v-model="formData.is_collection" :disabled="mode == 'edit'">
...
import { templateAdd, templateDetail, templateEdit } from '@/api/swap_template/template'
...
const handleSubmit = async () => {
    ...
    mode.value == 'edit' ? await templateEdit(formData) : await templateAdd(formData)
